...
import com.daggerdemo.utils.StringUtils;
...
public class ErrorProvider {
    ...
    public String getMessage(final ErrorType messageType) {
        switch (messageType) {
            ...
            case PROFILE_LOCKED:
                return context.getString(R.string.error_message_profile_locked);
            ...
            case CARD_NOT_INDIVIDUAL:
                return context.getString(R.string.error_message_not_individual_card);
